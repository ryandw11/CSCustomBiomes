...
public class LegacyCustomBiomeAddon_1_21_5 implements StructureSection {
    ...
    public boolean checkStructureConditions(Structure structure, Block block, Chunk chunk) {
        ...
        try {
            ...
            Registry<Biome> registry = dedicatedServer.registryAccess().getOrThrow(Registries.BIOME).value();
